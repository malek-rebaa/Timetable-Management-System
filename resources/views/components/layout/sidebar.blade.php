...
>
    ...
    <div class="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        <a href="{{ url('/') }}" class="flex items-center gap-3">
            ...
            <span class="text-xl font-bold text-gray-800 dark:text-white">{{ app(\App\Multitenancy\CurrentTenant::class)->school()?->name ?? 'EduTime' }}</span>
        </a>
    ...
    <div class="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
        <nav class="mt-5 py-4 px-4 lg:mt-9 lg:px-6">
            ...
            <div>
                ...
                <ul class="mb-6 flex flex-col gap-1.5">
                    <li>
                        <a href="{{ route('schools.index') }}" class="group menu-item {{ request()->routeIs('schools.*') ? 'menu-item-active' : 'menu-item-inactive' }}">
                            <i data-lucide="building-2" class="w-5 h-5 {{ request()->routeIs('schools.*') ? 'menu-item-icon-active' : 'menu-item-icon-inactive' }}"></i>
                    ...
                    <li>
                        <a href="{{ route('branding.edit') }}" class="group menu-item {{ request()->routeIs('branding.*') ? 'menu-item-active' : 'menu-item-inactive' }}">
                            <i data-lucide="palette" class="w-5 h-5 {{ request()->routeIs('branding.*') ? 'menu-item-icon-active' : 'menu-item-icon-inactive' }}"></i>
