...
<button <?php echo e($attributes->merge(['class' => 'inline-flex items-center justify-center gap-2 rounded-lg px-4 py-2.5 text-sm font-medium transition-all focus:outline-none focus:ring-4 ' . $classes])); ?>>
    <?php echo e($slot); ?>
